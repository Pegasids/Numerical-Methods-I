...
% Function GS.m for LAB 6 EXERCISE

% This function solves Ax = b using Gauss-Seidel iteration given a matrix
% A, vector b, and initial guess x_0.

function [] = GS(A,b,XO,tol)
n = length(A(1,:));
x = XO; % x is the solution vector
N = 1000; % max number of iterations

disp('SOLVING USING GAUSS-SEIDEL METHOD:')
